...
export const exceptionTypeLabels: Record<ExceptionType, string> = {
    ...
    UNVERIFIED_BANK: 'حساب غير موثق من HR',
    BANK_NAME_MISMATCH: 'اسم صاحب الحساب مختلف',
    MISSING_CONTRACT: 'لا يوجد عقد عمل',
    EXPIRED_CONTRACT: 'عقد العمل منتهي',
    EXPIRING_CONTRACT_30: 'عقد ينتهي خلال 30 يوم',
    EXPIRING_CONTRACT_60: 'عقد ينتهي خلال 60 يوم',
    MISSING_CONTRACT_DATES: 'تواريخ العقد غير مكتملة',
    MISSING_NATIONAL_ID: 'رقم الهوية/الإقامة مفقود',
    EXPIRED_IQAMA: 'الإقامة منتهية الصلاحية',
    EXPIRING_IQAMA_60: 'الإقامة تنتهي خلال 60 يوم',
    EXPIRING_IQAMA_30: 'الإقامة تنتهي خلال 30 يوم',
    MISSING_SALARY: 'لم يتم تعيين هيكل راتب',
    NEGATIVE_NET: 'صافي الراتب سالب أو صفر',
    BELOW_MINIMUM_SAUDI: 'راتب أقل من 3000 (لا يحتسب)',
    SALARY_MISMATCH: 'الراتب لا يطابق العقد',
    MISSING_GOSI_NUMBER: 'غير مسجل في التأمينات',
    HALF_COUNTED_SAUDI: 'راتب 3000-4000 (يحتسب نصف سعودي)',
};
