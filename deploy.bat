...
ssh -i C:\Users\Administrator\.ssh\id_rsa root@72.61.239.170 "cd /var/www/attendance-system && git stash && git pull origin main && cd backend && npm install && npx prisma generate && npm run build && pm2 restart backend && echo '=== DEPLOY SUCCESS! ===' || echo '=== VPS BUILD FAILED ==='"
