...
const goal_data_source_service_1 = require("./goal-data-source.service");
...
exports.GoalsModule = GoalsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [goals_service_1.GoalsService, goal_data_source_service_1.GoalDataSourceService],
        exports: [goals_service_1.GoalsService, goal_data_source_service_1.GoalDataSourceService],
    })
], GoalsModule);
