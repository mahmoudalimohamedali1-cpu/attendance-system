...
var AiCodeGeneratorService_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.AiCodeGeneratorService = void 0;
const common_1 = require("@nestjs/common");
const fs = require("fs");
const path = require("path");
let AiCodeGeneratorService = AiCodeGeneratorService_1 = class AiCodeGeneratorService {
    constructor() {
        this.logger = new common_1.Logger(AiCodeGeneratorService_1.name);
        this.srcPath = path.join(process.cwd(), 'src', 'modules');
        this.frontendPath = path.join(process.cwd(), '..', 'web-admin', 'src');
    }
...
`;
    ...
    async createModuleFiles(modelName, fields) {
    ...
    async updateAppModule(modelName) {
    ...
    async createAndRegisterModule(modelName, fields) {
    ...
    generateFrontendService(modelName) {
...
`;
    ...
    generateFrontendPage(modelName, fields) {
        const serviceName = `${this.toCamelCase(modelName)}Service`;
...
`;
    ...
    async createFrontendFiles(modelName, fields) {
        const createdFiles = [];
        try {
    ...
    async updateFrontendRouter(modelName) {
    ...
    async createFullStack(modelName, fields) {
    ...
    async rebuildBackend() {
        ...
        setImmediate(() => {
            exec('npx prisma generate && npx prisma db push --accept-data-loss && npm run build && pm2 restart attendance-backend', { cwd: backendPath, timeout: 300000 }, (error, stdout, stderr) => {
                if (error) {
    ...
    async rebuildFrontend() {
        ...
        return new Promise((resolve) => {
            ...
            exec('npm run build', { cwd: frontendPath, timeout: 180000 }, (error, stdout, stderr) => {
                if (error) {
...
exports.AiCodeGeneratorService = AiCodeGeneratorService;
exports.AiCodeGeneratorService = AiCodeGeneratorService = AiCodeGeneratorService_1 = __decorate([
    (0, common_1.Injectable)()
], AiCodeGeneratorService);
//# sourceMappingURL=ai-code-generator.service.js.map