...
const stuck_detection_service_1 = require("../../common/services/stuck-detection.service");
...
exports.AuditLogsModule = AuditLogsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [status_log_service_1.StatusLogService, stuck_detection_service_1.StuckDetectionService],
    })
], AuditLogsModule);
