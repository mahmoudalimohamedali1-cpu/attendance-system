...
import { ExtendedReportQueryDto, AttendanceDetailedQueryDto, LateReportQueryDto, OvertimeReportQueryDto, PayrollReportQueryDto, LeaveReportQueryDto, EmployeeReportQueryDto, ContractExpiryQueryDto, CustodyReportQueryDto, ExecutiveDashboardData } from '../dto/extended-report.dto';
export declare class ExtendedReportsService {
    private prisma;
    private readonly logger;
    constructor(prisma: PrismaService);
    private getDateRange;
    private getPagination;
    getReportsCatalog(): import("../dto/extended-report.dto").ReportDefinition[];
    getDailyAttendance(companyId: string, query: AttendanceDetailedQueryDto): Promise<{
        metadata: {
            reportName: string;
            reportNameEn: string;
            generatedAt: Date;
    ...
    getLateDetailsReport(companyId: string, query: LateReportQueryDto): Promise<{
        metadata: {
            reportName: string;
            reportNameEn: string;
            generatedAt: Date;
    ...
    getAbsenceReport(companyId: string, query: ExtendedReportQueryDto): Promise<{
        metadata: {
            reportName: string;
            reportNameEn: string;
            generatedAt: Date;
    ...
    getEarlyLeaveReport(companyId: string, query: ExtendedReportQueryDto): Promise<{
        metadata: {
            reportName: string;
            reportNameEn: string;
            generatedAt: Date;
    ...
    getOvertimeReport(companyId: string, query: OvertimeReportQueryDto): Promise<{
        metadata: {
            reportName: string;
            reportNameEn: string;
            generatedAt: Date;
    ...
    getWorkFromHomeReport(companyId: string, query: ExtendedReportQueryDto): Promise<{
        metadata: {
            reportName: string;
            reportNameEn: string;
            generatedAt: Date;
    ...
    getAttendanceByBranch(companyId: string, query: ExtendedReportQueryDto): Promise<{
        metadata: {
            reportName: string;
            reportNameEn: string;
            generatedAt: Date;
    ...
    getAttendanceByDepartment(companyId: string, query: ExtendedReportQueryDto): Promise<{
        metadata: {
            reportName: string;
            reportNameEn: string;
            generatedAt: Date;
    ...
    getComplianceReport(companyId: string, query: ExtendedReportQueryDto): Promise<{
        metadata: {
            reportName: string;
            reportNameEn: string;
            generatedAt: Date;
    ...
    getSuspiciousAttemptsReport(companyId: string, query: ExtendedReportQueryDto): Promise<{
        metadata: {
            reportName: string;
            reportNameEn: string;
            generatedAt: Date;
    ...
    getPayrollSummary(companyId: string, query: PayrollReportQueryDto): Promise<{
        metadata: {
            reportName: string;
            reportNameEn: string;
            generatedAt: Date;
    ...
    getGosiReport(companyId: string, query: PayrollReportQueryDto): Promise<{
        metadata: {
            reportName: string;
            reportNameEn: string;
            generatedAt: Date;
    ...
    getAdvancesReport(companyId: string, query: ExtendedReportQueryDto): Promise<{
        metadata: {
            reportName: string;
            reportNameEn: string;
            generatedAt: Date;
    ...
    getEmployeeList(companyId: string, query: EmployeeReportQueryDto): Promise<{
        metadata: {
            reportName: string;
            reportNameEn: string;
            generatedAt: Date;
    ...
    getContractExpiryReport(companyId: string, query: ContractExpiryQueryDto): Promise<{
        metadata: {
            reportName: string;
            reportNameEn: string;
            generatedAt: Date;
    ...
    getIqamaExpiryReport(companyId: string, query: ContractExpiryQueryDto): Promise<{
        metadata: {
            reportName: string;
            reportNameEn: string;
            generatedAt: Date;
    ...
    getNationalityAnalysis(companyId: string): Promise<{
        metadata: {
            reportName: string;
            reportNameEn: string;
            generatedAt: Date;
    ...
    getLeaveBalanceReport(companyId: string, query: LeaveReportQueryDto): Promise<{
        metadata: {
            reportName: string;
            reportNameEn: string;
            generatedAt: Date;
    ...
    getLeaveRequestsReport(companyId: string, query: LeaveReportQueryDto): Promise<{
        metadata: {
            reportName: string;
            reportNameEn: string;
            generatedAt: Date;
    ...
    getCustodyInventory(companyId: string, query: CustodyReportQueryDto): Promise<{
        metadata: {
            reportName: string;
            reportNameEn: string;
            generatedAt: Date;
    ...
    getExecutiveDashboard(companyId: string): Promise<ExecutiveDashboardData>;
}
