...
export declare class DisciplinaryController {
    ...
    createCase(req: any, dto: CreateCaseDto): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
    ...
    getCases(req: any, role?: 'manager' | 'hr' | 'employee'): Promise<({
        manager: {
            id: string;
            firstName: string;
            lastName: string;
    ...
    getCaseDetail(id: string, req: any): Promise<{
        deadlines: {
            decision: {
                date: Date;
    ...
    hrInitialReview(id: string, req: any, dto: HRReviewDto): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        status: import(".prisma/client").$Enums.DisciplinaryStatus;
    ...
    employeeInformalResponse(id: string, req: any, dto: EmployeeResponseDto): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        status: import(".prisma/client").$Enums.DisciplinaryStatus;
    ...
    issueDecision(id: string, req: any, dto: IssueDecisionDto): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        status: import(".prisma/client").$Enums.DisciplinaryStatus;
    ...
    finalizeCase(id: string, req: any): Promise<any>;
    objectionReview(id: string, req: any, dto: ObjectionReviewDto): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        status: import(".prisma/client").$Enums.DisciplinaryStatus;
    ...
    scheduleHearing(id: string, req: any, dto: {
    ...
    uploadMinutes(id: string, req: any, dto: {
        sessionNo: number;
        minutesText?: string;
    ...
    employeeDecisionResponse(id: string, req: any, dto: {
        action: 'ACCEPT' | 'OBJECT';
        objectionText?: string;
    }): Promise<any>;
    uploadAttachment(id: string, req: any, dto: {
        fileUrl: string;
        fileName: string;
        fileType: string;
    }): Promise<{
    ...
    uploadFiles(id: string, req: any, files: Express.Multer.File[]): Promise<{
        message: string;
        attachments: {
            id: string;
            createdAt: Date;
    ...
    toggleLegalHold(id: string, req: any, hold: boolean): Promise<{
        success: boolean;
        legalHold: boolean;
    }>;
}
