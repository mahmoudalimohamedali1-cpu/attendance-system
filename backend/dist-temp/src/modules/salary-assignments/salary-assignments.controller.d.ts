...
export declare class SalaryAssignmentsController {
    private readonly service;
    constructor(service: SalaryAssignmentsService);
    ...
    findAllAlt(companyId: string): Promise<({
        employee: {
            id: string;
            email: string;
            firstName: string;
    ...
    findByEmployee(id: string, companyId: string): Promise<({
        structure: {
            id: string;
            name: string;
            createdAt: Date;
    ...
    findActive(id: string, companyId: string): Promise<({
        structure: {
            lines: ({
                component: {
                    id: string;
