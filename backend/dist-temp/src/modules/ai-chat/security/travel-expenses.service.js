...
var TravelExpensesService_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.TravelExpensesService = void 0;
const common_1 = require("@nestjs/common");
let TravelExpensesService = TravelExpensesService_1 = class TravelExpensesService {
    constructor() {
        this.logger = new common_1.Logger(TravelExpensesService_1.name);
    ...
    createRequest(userId, userName, destination, purpose, departureDate, returnDate) {
    ...
    getPerDiem(country) {
        return this.perDiemRates.find(p => p.country.toLowerCase().includes(country.toLowerCase()) ||
            p.countryAr.includes(country)) || null;
    }
    getVisaInfo(country) {
        return this.visaInfo.find(v => v.country.toLowerCase().includes(country.toLowerCase()) ||
            v.countryAr.includes(country)) || null;
    }
    checkPolicy(request) {
        const policies = [];
...
exports.TravelExpensesService = TravelExpensesService = TravelExpensesService_1 = __decorate([
