/**
 * Report Definitions - Complete 55 Reports Library
 * Synced with Backend REPORTS_CATALOG (extended-report.dto.ts)
 */
...
export const REPORT_CATEGORIES: Record<ReportCategory, { name: string; icon: ElementType; color: string }> = {
    ...
    DISCIPLINARY: { name: 'التأديبية', icon: Gavel, color: '#f44336' },
...
export const REPORTS: ReportDefinition[] = [
    ...
    },
    {
        ...
        description: 'خصومات بسبب التأخير',
        category: 'PAYROLL',
        accessLevel: 'ADMIN',
        icon: MoneyOff,
    ...
    },
    {
        ...
        description: 'مقارنة بين الفترات',
        category: 'PAYROLL',
        accessLevel: 'ADMIN',
        icon: CompareArrows,
    ...
    },
    {
        ...
        description: 'إجمالي تكلفة كل موظف',
        category: 'PAYROLL',
        accessLevel: 'ADMIN',
        icon: PriceCheck,
    ...
    },
    {
        ...
        description: 'تحليل استخدام الإجازات',
        category: 'LEAVES',
        accessLevel: 'ADMIN',
        icon: DonutLarge,
    ...
    },
    {
        ...
        nameEn: 'Sick Leaves',
        description: 'سجل الإجازات المرضية',
        category: 'LEAVES',
        accessLevel: 'MANAGER',
        icon: LocalHospital,
    ...
    },
    {
        ...
        description: 'غياب بدون إجازة مسجلة',
        category: 'LEAVES',
        accessLevel: 'MANAGER',
        icon: ReportProblem,
    ...
    },
    {
        ...
        description: 'تحليل الدوران الوظيفي',
        category: 'HR',
        accessLevel: 'ADMIN',
        icon: SwapHoriz,
    ...
    },
    {
        ...
        description: 'توزيع المخالفات حسب نوعها',
        category: 'DISCIPLINARY',
        accessLevel: 'ADMIN',
        icon: ErrorIcon,
    ...
    },
    {
        ...
        nameEn: 'Risk Alerts',
        description: 'تنبيهات ذكية للمشاكل',
        category: 'EXECUTIVE',
        accessLevel: 'ADMIN',
        icon: ReportProblem,
...
// Total: 55 reports (10 Attendance + 12 Payroll + 8 Leaves + 10 HR + 6 Disciplinary + 5 Custody + 4 Executive)
