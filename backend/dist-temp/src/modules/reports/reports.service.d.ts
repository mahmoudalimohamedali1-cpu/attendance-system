...
export declare class ReportsService {
    ...
    constructor(prisma: PrismaService, exportService: ExportService, permissionsService: PermissionsService);
    private getPayrollSummaryMetrics;
    getDashboardStats(companyId: string, userId?: string, userRole?: string): Promise<{
        employees: {
            total: number;
            active: number;
        };
    ...
    getWeeklySummary(userId?: string, userRole?: string): Promise<{
        data: {
            date: string;
            present: number;
            late: number;
    ...
    getAttendanceReport(query: ReportQueryDto, companyId: string, requesterId?: string): Promise<{
        data: ({
            user: {
                id: string;
                firstName: string;
    ...
    getEmployeeReport(userId: string, query: ReportQueryDto, companyId: string, requesterId?: string): Promise<{
        employee: ({
            branch: {
                id: string;
                name: string;
    ...
    getLateReport(query: ReportQueryDto, companyId: string, requesterId?: string): Promise<{
        data: ({
            user: {
                id: string;
                firstName: string;
    ...
    getPayrollSummary(query: ReportQueryDto, companyId: string): Promise<{
        employeeId: string;
        employeeCode: string | null;
        employeeName: string;
    ...
    exportToExcel(reportType: string, query: ReportQueryDto, companyId: string, requesterId?: string): Promise<Buffer>;
    exportToPdf(reportType: string, query: ReportQueryDto, companyId: string, requesterId?: string): Promise<Buffer>;
    private calculateAttendanceStats;
    private groupLateByEmployee;
    private calculateLateDeduction;
    private calculateAbsentDeduction;
    private calculateOvertimeBonus;
}
