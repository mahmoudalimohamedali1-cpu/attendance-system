...
__decorate([
    (0, swagger_2.ApiPropertyOptional)({ description: 'نسبة الإنجاز (0-100)', minimum: 0, maximum: 100 }),
...
__decorate([
    (0, swagger_2.ApiPropertyOptional)({ description: 'ترتيب المهمة في الكانبان' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsInt)(),
    (0, class_validator_1.Min)(0),
    __metadata("design:type", Number)
