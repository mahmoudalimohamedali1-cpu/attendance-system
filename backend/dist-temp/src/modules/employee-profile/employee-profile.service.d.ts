...
import { UpdateProfileDto, RequestOnBehalfDto, AttendanceStatsResponse, LeaveBalanceResponse, SalaryInfoResponse, ActivityTimelineItem } from './dto/profile.dto';
export declare class EmployeeProfileService {
    private prisma;
    constructor(prisma: PrismaService);
    getFullProfile(userId: string, companyId: string, requesterId: string): Promise<{
    ...
    getOverview(userId: string, companyId: string): Promise<{
        yearsOfService: number;
        id: string;
        phone: string | null;
        email: string;
    ...
    getAttendanceStats(userId: string, companyId: string, startDate?: string, endDate?: string): Promise<AttendanceStatsResponse>;
    getLeaveHistory(userId: string, companyId: string): Promise<LeaveBalanceResponse & {
        requests: any[];
    }>;
    getSalaryInfo(userId: string, companyId: string): Promise<SalaryInfoResponse>;
    getDocuments(userId: string, companyId: string): Promise<{
        documents: never[];
        byType: {};
        expiringDocuments: never[];
        totalCount: number;
    }>;
    uploadDocument(userId: string, companyId: string, uploadedById: string, data: {
        type: string;
        title: string;
        titleAr?: string;
        description?: string;
    ...
    getActivityTimeline(userId: string, companyId: string, limit?: number): Promise<ActivityTimelineItem[]>;
    updateProfile(userId: string, companyId: string, requesterId: string, data: UpdateProfileDto): Promise<{
        id: string;
        phone: string | null;
        email: string;
        createdAt: Date;
    ...
    approveProfileUpdate(requestId: string, reviewerId: string, companyId: string): Promise<void>;
    createRequestOnBehalf(userId: string, companyId: string, requesterId: string, data: RequestOnBehalfDto): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
    ...
    private getLeaveTypeAr;
    private getLetterTypeAr;
    private createLeaveOnBehalf;
    private createLetterOnBehalf;
    private createAdvanceOnBehalf;
    deleteDocument(userId: string, docId: string, companyId: string): Promise<void>;
}
